...
export default function MainLayout({ controller }) {
  ...
  return (
    <div className="bg-slate-900 min-h-screen">
      <div className="flex-grow flex flex-col md:flex-row min-h-screen md:h-screen md:overflow-hidden font-sans bg-slate-50 w-full shadow-2xl relative">
        
        {/* Mobile Header */}
        <div className="md:hidden sticky top-0 flex items-center justify-between px-5 py-4 bg-slate-900 text-white shadow-md z-50">
        ...
        {/* Main Content Area */}
        <main className="flex-grow flex flex-col min-w-0 p-4 sm:p-5 md:p-7 overflow-y-auto h-auto md:h-full bg-slate-50">
          <Outlet />
        </main>
      </div>
    </div>
